var app = (function () {
    ...
    /* src/components/Thing.svelte generated by Svelte v3.16.5 */
    ...
    /* src/components/Game.svelte generated by Svelte v3.16.5 */
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const thing_changes = {};
    			if (dirty & /*things*/ 1) thing_changes.thing = /*thing*/ ctx[5];
    ...
    /* src/components/Timer.svelte generated by Svelte v3.16.5 */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if ((!current || dirty & /*timeComplete*/ 2) && t2_value !== (t2_value = (/*timeComplete*/ ctx[1] ? "Final " : "") + "")) set_data_dev(t2, t2_value);
    			if (!current || dirty & /*$score*/ 8) set_data_dev(t4, /*$score*/ ctx[3]);
    		},
    		i: function intro(local) {
    			if (current) return;
